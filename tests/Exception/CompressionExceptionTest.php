...
final class CompressionExceptionTest extends TestCase
{
    public function testItRetainsExceptionContext(): void
    {
        $previous = new RuntimeException('root cause');
        $exception = new CompressionException('compression failed', 17, $previous);

        self::assertInstanceOf(FontExceptionInterface::class, $exception);
        self::assertSame('compression failed', $exception->getMessage());
