...
#[CoversClass(FontNotFoundException::class)]
final class FontNotFoundExceptionTest extends TestCase
{
    public function testItRetainsExceptionContext(): void
    {
        $previous = new RuntimeException('root cause');
        $exception = new FontNotFoundException('font missing', 17, $previous);

        self::assertInstanceOf(FontExceptionInterface::class, $exception);
        self::assertSame('font missing', $exception->getMessage());
